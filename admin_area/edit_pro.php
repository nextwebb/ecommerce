...
if(isset($_GET['edit_pro'])){
	...
	$get_id = $_GET['edit_pro']; //this Get variable holds the product id.
	...
	$row_pro=mysqli_fetch_array($run_pro);//we just need one product to edit. so we dont need a while loop

		//from this point on , every variable here belongs to just one product=$get_id
